            ...
            <View
              style={
                splitOrientation === "vertical"
                  ? styles.splitScreenContainerVertical
                  : styles.splitScreenContainerHorizontal
              }
            >
              <View
                style={
                ...
                {isControlGroupExpanded ? (
                  <View
                    style={{
                      flex: 1,
                      flexDirection:
                        splitOrientation === "horizontal" ? "column" : "row",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
                  >
