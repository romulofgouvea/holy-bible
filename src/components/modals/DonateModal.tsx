      ...
      header={
        <View style={styles.header}>
          ...
          <BibleText
            style={[
              styles.headerTitle,
              { fontSize: ms(DESIGN.fontSize.lg), color: colors.primary },
            ]}
          >
            Apoie este Projeto
          </BibleText>
    ...
    >
      <View style={[styles.bodyContent, { gap: ms(DESIGN.spacing.lg) }]}>
        <View style={{ gap: ms(DESIGN.spacing.xs) }}>
          ...
          >
            Este aplicativo é gratuito e feito com muito cuidado para levar a
            Palavra de Deus às suas mãos.
          </BibleText>

          <BibleText
            style={[
              styles.bodySmall,
              { color: colors.textMuted, fontSize: ms(DESIGN.fontSize.md) },
            ]}
          >
            Cada contribuição ajuda a manter os servidores e a adicionar novas
            funcionalidades. 🙏
          </BibleText>
        </View>
        ...
        >
          ...
          <TouchableOpacity
            style={[
              styles.copyBtn,
              { backgroundColor: copied ? "#4CAF50" : colors.primary },
            ]}
            onPress={handleCopy}
            activeOpacity={0.8}
          >
